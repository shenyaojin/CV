...
\resumeSubheading
  ...
  \resumeItemListStart
    ...
    \resumeItem{\textbf{Focus}: \textit{Distributed fiber-optic sensing (DFOS), reservoir simulation, hydraulic fracture characterization, inversion problems}}
...
\resumeSubHeadingListStart
    \resumeItem{\textbf{Jin, S.}, and Jin, G. (2026). Low-Frequency DAS for Cement Quality Monitoring in Horizontal Wells. \textit{SPE Journal} (finished, submission target Q4 2026); abstract will be submitted to URTeC 2026.}
